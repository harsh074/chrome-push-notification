'use strict';
app.service('utilityService',["$q","$http","$state","ipCookie","CONSTANTS", function utilityService($q, $http, $state, ipCookie,CONSTANTS) {
	var service = {
		'authenticated': null,
		...
		'initialize': function(url, sessions, scope){
			this.API_URL = url;
